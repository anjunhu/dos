...
class MultiviewDiffusionGuidance(nn.Module):
    def __init__(self, device, cache_dir=None, hf_key=None, torch_dtype=torch.float16):
        ...
        print(f"Loaded Multiview Stable Diffusion!")
    ...
    def get_text_embeds(
        ...
        # return torch.cat([text_embeddings, uncond_text_embeddings], dim=0) # ThreeStudio implementation returns this way.
        return torch.cat([uncond_text_embeddings,text_embeddings], dim=0)
