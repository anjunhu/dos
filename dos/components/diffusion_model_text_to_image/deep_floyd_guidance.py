...
from prompt_processors_base import PromptProcessorOutput
from .utils.base import BaseObject
from .utils.misc import C, parse_version
from .utils.ops import perpendicular_component
from .utils.typing import *


@register("deep-floyd-guidance")
...
if __name__ == '__main__':
    # Create an instance of DeepFloydGuidance
