...
class Articulator(BaseModel):
    ...
    def __init__(
        ...
        self.texture_predictor = (texture_predictor if texture_predictor else TexturePredictor())
        
        self.bones_predictor = (bones_predictor if bones_predictor else BonesEstimator())
